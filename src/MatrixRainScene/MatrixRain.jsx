...
// const VALID_CHARS = `ㄱㄴㄷㄹㅁㅂㅅㅇㅈㅊㅋㅌㅍㅎㅏㅑㅓㅕㅗㅛㅜㅠㅡㅣㄲㄸㅃㅉㅆㅢㅚㅐㅟㅔㅒㅖㅘㅝㅙㅞあいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみむめもやゆよらりるれろわをんabcdefghijklmnopqrstuvwxyz0123456789$+-*/=%"'#&_(),.;:?!\\|{}<>[]^~աբգդեզէըթժիլխծկհձղճմյնշոչպջռսվտրցւփքօեւուֆОоАаЭэБбҐґГгХхДдЕеЁёЯяДЗдзДЖджЗзЖжІіЙйКкЛлМмНнПпРрСсШшТтВвУуЎўФфЬьЦцЧчЫыЮюاΑαΒβΓγΔδΕεΖζΗηΘθΙιΚκΛλΜμΝνΞξΟοΠπΡρΣσ/ςΤτΥυΦφΧχΨψΩωبجدهوزحطيكلمنسعفصقرشتثخذضظغ`;
const STREAM_MUTATION_ODDS = 0.04;
